...
public class oAuthTest {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		{
			a.add(w.get(j).getCourseTitle());//adding all courses list into array list
		}

		List<String> expectedList=	Arrays.asList(courseTitles);//Arrays.asList method converts arrays to array list
